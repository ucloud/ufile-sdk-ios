...
#define LOG4CPLUS_STATIC
    ...
    extern int UFile_IOS_LOG_LEVEL;
    extern int UFile_IOS_FLAG_FATAL;
    extern int UFile_IOS_FLAG_ERROR;
    extern int UFile_IOS_FLAG_WARN;
    extern int UFile_IOS_FLAG_INFO;
    extern int UFile_IOS_FLAG_DEBUG;
class UCloudLog{
public:
